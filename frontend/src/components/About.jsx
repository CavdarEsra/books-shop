      ...
      <div className='flexCenter flex-col gap-16 xl:gap-8 xl:flex-row'>
          ...
          <div className='flex flex-col items-start gap-y-4'>
            <div className='flexCenter gap-x-4'>
              ...
              <div>
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quidem voluptatem pariatur veniam eum.</p>
              </div>
            </div>
            <div className='flexCenter gap-x-4'>
              <div className='h-16 min-w-16 bg-secondaryOne flexCenter rounded-md'>
        ...
        <div className='flex-1 flexCenter'>
          <div className='bg-secondaryOne flexCenter p-24 max-h-[33rem] max-w-[33rem] rounded-3xl'>
            <img src={about} height={244} width={244} className='shadow-2xl shadow-slate-900/50 rounded-lg'/>
          </div>
        </div>
      </div>
    </section>
